...
<button
  ...
  type="button"
  data-modal-target="#modal-wq5sc7lrwyo">
  Show modal
</button>

<div
  data-modal
  id="modal-wq5sc7lrwyo"
  class="bx--modal "
  role="dialog"
  aria-modal="true"
  aria-labelledby="modal-wq5sc7lrwyo-label"
  aria-describedby="modal-wq5sc7lrwyo-heading"
  tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p
        class="bx--modal-header__label bx--type-delta"
        id="modal-wq5sc7lrwyo-label">
        Optional label
      </p>
      <p
        class="bx--modal-header__heading bx--type-beta"
        id="modal-wq5sc7lrwyo-heading">
        Modal heading
      </p>
      <button
        ...
        <svg
          ...
          aria-hidden="true">
          <path
            d="M12 4.7L11.3 4 8 7.3 4.7 4 4 4.7 7.3 8 4 11.3 4.7 12 8 8.7 11.3
            12 12 11.3 8.7 8z" />
        </svg>
      </button>
    </div>
